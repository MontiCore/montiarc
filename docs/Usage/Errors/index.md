...
### 0xC1166 - *Port Named Tick*

##### Description
A port is named `Tick`, which conflicts with built-in timing.

##### Example

```montiarc
component A { in Integer Tick; }
```

---

### 0xC1168 - *Component Named Tick*

##### Description
A component is named `Tick`, reserved for timing semantics.
...
### 0xC1169 - *ComponentInstance Named Tick*

##### Description
A subcomponent instance is named `Tick`, reserved.
...
### 0xC1170 - *Parameter Named Tick*

##### Description
A parameter is named `Tick`, which is not allowed.

##### Example

```montiarc
component A(int Tick) {}
```

---

### 0xC1171 - *Field Named Tick*

##### Description
A component field is named `Tick`, reserved.
...
### 0xC1172 - *TypeParameters Named Tick*

##### Description
A type parameter is named `Tick`, which is disallowed.
...
### 0xC1173 - *Feature Named Tick*

##### Description
A feature (e.g. mode, port) named `Tick` conflicts with system timing.

##### Example

```montiarc
component A {feature Tick;}
