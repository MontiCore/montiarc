...
MontiArc has an integration for class diagrams written with [_cd4code_](https://github.com/MontiCore/cd4analysis) (a language extension of _cd4analysis_).
...
You can find comprehensive information on how to define types with cd4code [here](https://github.com/MontiCore/cd4analysis).
Moreover, there are [several examples](https://github.com/MontiCore/cd4analysis/tree/dev/cdlang/src/test/resources/de/monticore/cd4analysis/examples) of cd4code models.
...
```
When calling constructors of object-oriented types in MontiArc, one calls the constructor as if it were a method of the defining type:
```java
