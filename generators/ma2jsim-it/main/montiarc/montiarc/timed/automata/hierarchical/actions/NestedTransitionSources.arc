...
component NestedTransitionSources {
  ...
  automaton {
    ...
    INIT -> a [i.equals("a")] i / o = "INIT -> a";
    INIT -> b [i.equals("b")] i / o = "INIT -> b";
    INIT -> c [i.equals("c")] i / o = "INIT -> c";
    INIT -> d [i.equals("d")] i / o = "INIT -> d";
    INIT -> e [i.equals("e")] i / o = "INIT -> e";
    INIT -> f [i.equals("f")] i / o = "INIT -> f";
    INIT -> Neutral [i.equals("Neutral")] i / o = "INIT -> N";



    // Transitions that we want to check:
    // * Oneself or a super state is the transition source
    a -> Neutral [i.equals("a -> N")] i / o = "a -> N";
    b -> Neutral [i.equals("b -> N")] i / o = "b -> N";
    c -> Neutral [i.equals("c -> N")] i / o = "c -> N";
    d -> Neutral [i.equals("d -> N")] i / o = "d -> N";

    bb -> Neutral [i.equals("bb -> N")] i / o = "bb -> N";

    ccc -> Neutral [i.equals("ccc -> N")] i / o = "ccc -> N";
    ddd -> Neutral [i.equals("ddd -> N")] i / o = "ddd -> N";
    eee -> Neutral [i.equals("eee -> N")] i / o = "eee -> N";
    fff -> Neutral [i.equals("fff -> N")] i / o = "fff -> N";
