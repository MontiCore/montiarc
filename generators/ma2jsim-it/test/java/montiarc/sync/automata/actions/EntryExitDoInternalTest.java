...
class EntryExitDoInternalTest {
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      Arguments.of(
        List.of(msg("noop"), tk(), msg("noop"), tk(), msg("noop"), tk()),
        List.of(msg("Enter A"),                        // <- Initial state entered
          msg("Do A"), tk(),                           // <- Action of first time frame
          msg("Do A"), tk(),  // <- Action of second time frame
          msg("Do A"), tk())                           // <- ...
      ),
      /*  // This test case is deactivated, because internal transitions are not yet supported. It would replace the one above it
      Arguments.of(
        List.of(msg("noop"), tk(), msg("internal"), tk(), msg("noop"), tk()),
        List.of(msg("Enter A"),                              // <- Initial state entered
                msg("Do A"), tk(),                           // <- Action of first time frame
      ...
      */
      Arguments.of(
        List.of(msg("loop"), tk(), msg("loop"), tk()),
        List.of(msg("Enter A"),
                msg("Exit A"), msg("A -> A"), msg("Enter A"), msg("Do A"), tk(),
                msg("Exit A"), msg("A -> A"), msg("Enter A"), msg("Do A"), tk())
      ),
      Arguments.of(
        List.of(msg("switch"), tk(), msg("switch"), tk(), msg("noop"), tk()),
        List.of(msg("Enter A"),
      ...
      Arguments.of(
        List.of(msg("switch"), tk(), msg("noop"), tk(), msg("loop"), tk(), msg("switch"), tk(), msg("noop"), tk()),
        List.of(msg("Enter A"),
                msg("Exit A"), msg("A -> B"), msg("Enter B"), msg("Do B"), tk(),
                msg("Do B"), tk(),
                msg("Exit B"), msg("B -> B"), msg("Enter B"), msg("Do B"), tk(),
