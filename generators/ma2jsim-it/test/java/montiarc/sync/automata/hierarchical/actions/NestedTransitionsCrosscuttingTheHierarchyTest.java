...
class NestedTransitionsCrosscuttingTheHierarchyTest {
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      // aaa_aaa -> aaa_aab
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aaa -> aaa_aab"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
      ...
      // aaa_aaa -> aaa_aba
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aaa -> aaa_aba"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_aaa -> aaa_baa
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aaa -> aaa_baa"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_aa -> aaa_ab
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aa -> aaa_ab"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_aa -> aaa_ba
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aa -> aaa_ba"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_aa -> aab_aa
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_aa -> aab_aa"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_a -> aaa_b
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_a -> aaa_b"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_a -> aab_a
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_a -> aab_a"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aaa_a -> aba_a
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aaa_a -> aba_a"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
      ...
      // aa -> baa
      Arguments.of(
        List.of(msg("aaa_aaa"), tk(), msg("aa -> baa"), tk()),
        List.of(
          msg("INIT -> aaa_aaa"),
            enter("a"), enter("aa"), enter("aaa"), enter("aaa_a"), enter("aaa_aa"), enter("aaa_aaa"),
            doo("a"), doo("aa"), doo("aaa"), doo("aaa_a"), doo("aaa_aa"), doo("aaa_aaa"), tk(),
