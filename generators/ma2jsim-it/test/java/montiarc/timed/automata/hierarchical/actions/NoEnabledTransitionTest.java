...
class NoEnabledTransitionTest {
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      // "aa"
      Arguments.of(
        List.of(msg("aa"), noTrigger(), tk(), noTrigger(), noTrigger(), tk(), tk()),
        List.of(
          msg("INIT -> aa"), enter("a"), enter("aa"),
              doo("a"), doo("aa"), tk(),
          doo("a"), doo("aa"), tk(),
          doo("a"), doo("aa"), tk()
        )
      ...
      // "bbb"
      Arguments.of(
        List.of(msg("bbb"), noTrigger(), tk(), noTrigger(), noTrigger(), tk(), tk()),
        List.of(
      ...
      // "ccc_c"
      Arguments.of(
        List.of(msg("ccc_c"), noTrigger(), tk(), noTrigger(), noTrigger(), tk(), tk()),
        List.of(
      ...
      // "ddd_dd"
      Arguments.of(
        List.of(msg("ddd_dd"), noTrigger(), tk(), noTrigger(), noTrigger(), tk(), tk()),
        List.of(
  ...
  private static Message<String> noTrigger() {
    return msg("no-trigger");
  }
}
