...
class NestedTransitionsInSameHierarchyTest {
  ...
  static Stream<Arguments> moveUpTheHierarchy() {
    return Stream.of(
      ...
      // ccc -> c without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("ccc -> c"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
      ...
      // ccc -> cc without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("ccc -> cc"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"),
      ...
      // ddd -> d without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("ddd -> d"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"), exit("d"),
      ...
      // ddd -> dd without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("ddd -> dd"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"),
      ...
      // fff -> f without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> f"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"), exit("f"),
      ...
      // fff -> ff without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> ff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"),
      ...
      // fff_ff -> fff without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_ff -> fff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"),
      ...
      // fff_ff -> fff_f without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_ff -> fff_f"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"),
      ...
      // fff_fff -> fff_f without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_fff -> fff_f"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"),
      ...
      // fff_fff -> fff_ff without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_fff -> fff_ff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"),
  ...
  static Stream<Arguments> moveDownTheHierarchy() {
    return Stream.of(
      ...
      // b -> bz without intermediate tick
      Arguments.of(
        List.of(msg("b"), msg("b -> bz"), tk()),
        List.of(
          msg("INIT -> b"),
            enter("b"), enter("bb"),
          exit("bb"), exit("b"),
      ...
      // c -> cz without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("c -> cz"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
      ...
      // c -> czz without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("c -> czz"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
      ...
      // d -> dz without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("d -> dz"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"), exit("d"),
      ...
      // d -> dzz without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("d -> dzz"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"), exit("d"),
      ...
      // dd -> ddz without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("dd -> ddz"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"),
      ...
      // f -> ffz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("f -> ffz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"), exit("f"),
      ...
      // f -> fzz_z without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("f -> fzz_z"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"), exit("f"),
      ...
      // fff -> fff_zz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> fff_zz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"),
      ...
      // fff -> fff_zzz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> fff_zzz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"),
      ...
      // fff_f -> fff_fz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_f -> fff_fz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"),
  ...
  static Stream<Arguments> stayAtHierarchyLevel() {
    return Stream.of(
      ...
      // bb -> bz without intermediate tick
      Arguments.of(
        List.of(msg("b"), msg("bb -> bz"), tk()),
        List.of(
          msg("INIT -> b"),
            enter("b"), enter("bb"),
          exit("bb"),
      ...
      // cc -> cz without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("cc -> cz"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"),
      ...
      // dd -> dz without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("dd -> dz"), tk()),
        List.of(
          msg("INIT -> d"),
            enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"),
      ...
      // ee -> ez without intermediate tick
      Arguments.of(
        List.of(msg("e"), msg("ee -> ez"), tk()),
        List.of(
          msg("INIT -> e"),
            enter("e"), enter("ee"), enter("eee"), enter("eee_e"), enter("eee_ee"),
          exit("eee_ee"), exit("eee_e"), exit("eee"), exit("ee"),
      ...
      // ccc -> ccz without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("ccc -> ccz"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"),
      ...
      // ccc -> czz without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("ccc -> czz"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"),
      ...
      // fff -> fzz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> fzz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"),
      ...
      // fff_fff -> fff_ffz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_fff -> fff_ffz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"),
      ...
      // fff_fff -> fff_zzz without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_fff -> fff_zzz"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"),
      ...
      // b -> b without intermediate tick
      Arguments.of(
        List.of(msg("b"), msg("b -> b"), tk()),
        List.of(
          msg("INIT -> b"),
            enter("b"), enter("bb"),
          exit("bb"), exit("b"),
      ...
      // c -> c without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("c -> c"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
      ...
      // cc -> cc without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("cc -> cc"), tk()),
        List.of(
          msg("INIT -> c"),
            enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"),
      ...
      // fff -> fff without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> fff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"),
      ...
      // fff_ff -> fff_ff without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff_ff -> fff_ff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"),
      ...
      // fff_fff -> fff_fff
      Arguments.of(
        List.of(msg("f"), msg("fff_fff -> fff_fff"), tk()),
        List.of(
          msg("INIT -> f"),
            enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"),
