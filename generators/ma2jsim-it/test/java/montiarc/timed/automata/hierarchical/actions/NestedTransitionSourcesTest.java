...
class NestedTransitionSourcesTest {
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      ...
      // a -> N without intermediate tick
      Arguments.of(
        List.of(msg("a"), msg("a -> N"), tk()),
        List.of(
          msg("INIT -> a"), enter("a"),
          exit("a"), msg("a -> N"), enter("N"), doo("N"), tk()
        )
      ...
      // b -> N without intermediate tick
      Arguments.of(
        List.of(msg("b"), msg("b -> N"), tk()),
        List.of(
          msg("INIT -> b"), enter("b"), enter("bb"),
          exit("bb"), exit("b"),
          msg("b -> N"), enter("N"), doo("N"), tk()
        )
      ),
      // c -> N
      Arguments.of(
      ...
      // c -> N without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("c -> N"), tk()),
        List.of(
          msg("INIT -> c"), enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
          msg("c -> N"), enter("N"), doo("N"), tk()
      ...
      // d -> N without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("d -> N"), tk()),
        List.of(
          msg("INIT -> d"), enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"), exit("d"),
          msg("d -> N"), enter("N"), doo("N"), tk()
      ...
      // bb -> N without intermediate tick
      Arguments.of(
        List.of(msg("b"), msg("bb -> N"), tk()),
        List.of(
          msg("INIT -> b"), enter("b"), enter("bb"),
          exit("bb"), exit("b"), msg("bb -> N"), enter("N"), doo("N"), tk()
        )
      ...
      // ccc -> N  without intermediate tick
      Arguments.of(
        List.of(msg("c"), msg("ccc -> N"), tk()),
        List.of(
          msg("INIT -> c"), enter("c"), enter("cc"), enter("ccc"),
          exit("ccc"), exit("cc"), exit("c"),
          msg("ccc -> N"), enter("N"), doo("N"), tk()
      ...
      // ddd -> N without intermediate tick
      Arguments.of(
        List.of(msg("d"), msg("ddd -> N"), tk()),
        List.of(
          msg("INIT -> d"), enter("d"), enter("dd"), enter("ddd"), enter("ddd_d"),
          exit("ddd_d"), exit("ddd"), exit("dd"), exit("d"),
          msg("ddd -> N"), enter("N"), doo("N"), tk()
      ...
      // eee -> N without intermediate tick
      Arguments.of(
        List.of(msg("e"), msg("eee -> N"), tk()),
        List.of(
          msg("INIT -> e"), enter("e"), enter("ee"), enter("eee"), enter("eee_e"), enter("eee_ee"),
          exit("eee_ee"), exit("eee_e"), exit("eee"), exit("ee"), exit("e"),
          msg("eee -> N"), enter("N"), doo("N"), tk()
      ...
      // fff -> N without intermediate tick
      Arguments.of(
        List.of(msg("f"), msg("fff -> N"), tk()),
        List.of(
          msg("INIT -> f"), enter("f"), enter("ff"), enter("fff"), enter("fff_f"), enter("fff_ff"), enter("fff_fff"),
          exit("fff_fff"), exit("fff_ff"), exit("fff_f"), exit("fff"), exit("ff"), exit("f"),
          msg("fff -> N"), enter("N"), doo("N"), tk()
