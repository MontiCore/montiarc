...
public class InnerTransitionTickTriggeredTest {
  /**
  ...
  void testIO(@NotNull List<Message<Integer>> input,
    ...
    // Given
    InnerTransitionTickTriggeredComp sut = new InnerTransitionTickTriggeredCompBuilder().setName("sut").build();
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      ...
      Arguments.of(
        List.of(msg(1), msg(2), tk()),
        List.of(msg(OFF), msg(OFF), tk())
      )
    );
  }
}
