...
class LongForwardTest {
  ...
  void testIO(@NotNull List<Long> input,
    ...
    // Given
    LongForwardComp sut = new LongForwardCompBuilder().setScheduler(new InstantSchedule()).setName("sut").build();
    ...
    // Then
    List<Long> actualAsBytes = this.actual_outVal.getAllValues().stream()
  ...
  static Stream<Arguments> io() {
    return Stream.of(
      ...
      Arguments.of(
        List.<Long>of(1L, 2L, Long.MAX_VALUE),
        List.<Long>of(1L, 2L, Long.MAX_VALUE)
      )
    );
  }
