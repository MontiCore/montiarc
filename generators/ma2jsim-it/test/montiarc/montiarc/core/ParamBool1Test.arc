...
<<test, p=[
  ...
  Untimed<true>, Untimed<true>, Untimed<false>, Untimed<false>,
  Untimed<true, true>, Untimed<true, true>, Untimed<true, true>, Untimed<true, true>,
  Untimed<false, false>, Untimed<false, false>, Untimed<false, false>, Untimed<false, false>
]>>
component ParamBool1Test(boolean p, UntimedStream<boolean> input, UntimedStream<boolean> expected) {
  ParamBool1 sut(p);
