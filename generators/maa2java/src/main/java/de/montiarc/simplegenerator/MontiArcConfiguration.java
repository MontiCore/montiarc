 ...
 * @author Robert Heim
 */
public class MontiArcConfiguration implements Configuration {
  ...
  public enum Options {
    ...
    OUT("out"), OUT_SHORT("o"), HANDCODEDPATH("handcodedPath"), GRAMMARS("grammars"), MODEL("model"), MODELS("models");
  ...
  /**
   * Factory method for {@link MontiArcConfiguration}.
   */
  public static MontiArcConfiguration withConfiguration(Configuration configuration) {
    return new MontiArcConfiguration(configuration);
  }
  
  /**
   * Constructor for {@link MontiArcConfiguration}
   */
  private MontiArcConfiguration(Configuration internal) {
