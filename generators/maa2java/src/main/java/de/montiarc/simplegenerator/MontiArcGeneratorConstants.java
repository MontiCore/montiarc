...
public final class MontiArcGeneratorConstants {
  ...
  /**
   * Turn this on, if components with a single incoming port should be optimized by merging port and
   * component object.
   * 
   * @since 2.5.0
   */
  public static final boolean optimizeSingleIn = false;
  ...
  /**
   * Key used to store the time paradigm of the current component in the {@link TemplateOperator}.
   * 
   * @since 2.3.0
   */
  ...
  /**
   * @return true, if components with a single incoming port should be optimized by merging port and
   * component object.
   * @since 2.5.0
   */
