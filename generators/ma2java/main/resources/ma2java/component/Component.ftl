...
<#macro printConstructor comp isTop>
  ...
  public ${name}(<@printParametersAsList comp/>) {
    <#if !comp.isEmptySuperComponents()>
      super(<#list comp.getSuperComponents(0).getParamBindingsAsList() as parentConfiguration>${compHelper.printExpression(parentConfiguration.getExpression())}<#sep>, </#sep></#list>);
    </#if>
