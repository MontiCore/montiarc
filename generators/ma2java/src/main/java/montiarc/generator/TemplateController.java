...
public class TemplateController extends de.monticore.generating.templateengine.TemplateController {

  public TemplateController(@NotNull GeneratorSetup setup, @NotNull String templateName) {
  ...
  protected String processTemplate(@NotNull String templateName, @NotNull Formatter formatter, @NotNull ASTNode ast,
    ...
    if (builder.length() == 0) {
      Log.warn(String.format(MA2JavaError.TEMPLATE_OUTPUT_EMPTY.toString(), this.completeQualifiedName(templateName)));
    }
