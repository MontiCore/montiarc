...
public class MAADynRecConfiguration implements Configuration {
   ...
   */
  public static MAADynRecConfiguration withConfiguration(Configuration configuration) {
    return new MAADynRecConfiguration(configuration);
  }
  
  /**
   * Constructor for {@link TemplateClassGeneratorConfiguration}
   */
  private MAADynRecConfiguration(Configuration internal) {
