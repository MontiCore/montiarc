...
public class DynamicComponentGenerator {
  ...
  public String generateAtomicComponent(final ComponentSymbol comp) {
    ...
    _builder.append("Result;");
    _builder.newLineIfNotEmpty();
    _builder.append("import de.montiarcautomaton.runtimes.timesync.delegation.IDynamicComponent;");
    _builder.newLine();
    _builder.append("import de.montiarcautomaton.runtimes.timesync.delegation.Port;");
    _builder.newLine();
    _builder.append("import de.montiarcautomaton.runtimes.timesync.delegation.FileSystemLoader;");
    _builder.newLine();
    _builder.append("import de.montiarcautomaton.runtimes.timesync.delegation.LoaderManager;");
    _builder.newLine();
    _builder.append("import de.montiarcautomaton.runtimes.timesync.implementation.IComputable;");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Dynamic");
    String _name_2 = comp.getName();
    _builder.append(_name_2);
    String _printGenerics = this.printGenerics(comp);
    _builder.append(_printGenerics);
    ...
    _builder.append("implements IDynamicComponent {");
    _builder.newLine();
    _builder.append("  ");
    _builder.newLine();
    _builder.append("  ");
    ...
    _builder.newLine();
    _builder.append("  ");
    _builder.append("public Dynamic");
    String _name_7 = comp.getName();
    _builder.append(_name_7, "  ");
    _builder.append("(");
    {
    ...
    _builder.append("  ");
    _builder.newLine();
    _builder.append("public <T> void setPort(String name, Port<T> port){");
    _builder.newLine();
    {
      Collection<PortSymbol> _ports_2 = comp.getPorts();
      for(final PortSymbol inPort_2 : _ports_2) {
        _builder.append("\t");
        _builder.append("if (name.equals(");
        String _name_23 = inPort_2.getName();
        ...
        String _firstUpper_5 = StringExtensions.toFirstUpper(inPort_2.getName());
        _builder.append(_firstUpper_5, "\t\t");
        _builder.append("((Port<");
        String _printPortType_4 = helper.printPortType(inPort_2);
        _builder.append(_printPortType_4, "\t\t");
        _builder.append(">) port);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("}");
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public <T> Port<T> getPort(String name){");
    _builder.newLine();
    {
      Collection<PortSymbol> _outgoingPorts_3 = comp.getOutgoingPorts();
      for(final PortSymbol outPort : _outgoingPorts_3) {
        _builder.append("\t");
        _builder.append("if (name.equals(");
        String _name_24 = outPort.getName();
        _builder.append(_name_24, "\t");
        _builder.append(")){");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("return (Port<T>) getPort");
        String _firstUpper_6 = StringExtensions.toFirstUpper(outPort.getName());
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public void checkForCmp(){}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public List<Port> reconfigure(){");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("List<Port> list = new ArrayList<Port>();");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append("     ");
    _builder.newLine();
    _builder.append("public void propagatePortChanges(List<Port> changedPorts){}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public String getInstanceName(){");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append("    ");
    _builder.newLine();
    _builder.append("void setLoaderConfiguration(String s, String storeDir, String targetDir, LoaderManager loaderManager){}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("  ");
    _builder.newLine();
  ...
  public String generateComposedComponent(final ComponentSymbol comp) {
    ...
    _builder.newLine();
    {
      ...
      for(final PortSymbol inPort : _ports_1) {
        ...
        _builder.append("\t");
        _builder.append("setPort");
        String _firstUpper_2 = StringExtensions.toFirstUpper(inPort.getName());
        _builder.append(_firstUpper_2, "        \t\t");
        _builder.append("((Port<");
        String _printPortType_3 = helper.printPortType(inPort);
        _builder.append(_printPortType_3, "        \t\t");
        _builder.append(">) port);");
        _builder.newLineIfNotEmpty();
        _builder.append("        \t");
    ...
    {
      Collection<PortSymbol> _outgoingPorts = comp.getOutgoingPorts();
      for(final PortSymbol outPort : _outgoingPorts) {
        _builder.append("        \t");
        _builder.append("if (name.equals(");
        String _name_5 = outPort.getName();
        _builder.append(_name_5, "        \t");
        _builder.append(")){");
        _builder.newLineIfNotEmpty();
        _builder.append("        \t");
        _builder.append("\t");
        _builder.append("return (Port<T>) getPort");
        String _firstUpper_3 = StringExtensions.toFirstUpper(outPort.getName());
        _builder.append(_firstUpper_3, "        \t\t");
        _builder.append("();");
        _builder.newLineIfNotEmpty();
        _builder.append("        \t");
    ...
    _builder.newLine();
    {
      ...
      for(final ComponentInstanceSymbol subcomp : _subComponents) {
        ...
        _builder.append(" ");
        String _name_7 = subcomp.getName();
        _builder.append(_name_7, "  ");
        _builder.append(";  ");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      ...
      for(final ComponentInstanceSymbol subcomp_1 : _subComponents_1) {
        ...
        String _firstUpper_4 = StringExtensions.toFirstUpper(subcomp_1.getName());
        _builder.append(_firstUpper_4, "  ");
        _builder.append("() {");
        _builder.newLineIfNotEmpty();
        _builder.append("  ");
        _builder.append("  ");
        _builder.append("return this.");
        String _name_8 = subcomp_1.getName();
        _builder.append(_name_8, "    ");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
        _builder.append("  ");
    ...
    _builder.newLine();
    {
      ...
      for(final ComponentInstanceSymbol subcomponent : _subComponents_2) {
        _builder.append("    ");
        _builder.append("this.");
        String _name_13 = subcomponent.getName();
        _builder.append(_name_13, "    ");
        _builder.append(".compute();");
        _builder.newLineIfNotEmpty();
      }
