...
public class AJavaConfiguration implements Configuration {
  ...
  /**
   * Factory method for {@link AJavaConfiguration}.
   */
  public static AJavaConfiguration withConfiguration(Configuration configuration) {
    return new AJavaConfiguration(configuration);
  }
  
/**
 * Constructor for {@link AJavaConfiguration}
 */
private AJavaConfiguration(Configuration internal) {
