...
public class HighlightPackageNameRule implements TokenClassificationRule {

  @Override
  public boolean matches(Token token) {
    return (token.tokenPathMatches("mACompilationUnit.mCQualifiedName.*")) && token.isNameToken();
  }
