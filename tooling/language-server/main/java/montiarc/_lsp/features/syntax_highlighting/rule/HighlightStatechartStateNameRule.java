...
public class HighlightStatechartStateNameRule implements TokenClassificationRule {

  @Override
  public boolean matches(Token token) {
    return (token.tokenPathMatches(".*.sCState") || token.tokenPathMatches(".*.sCTransition"))
      && token.isNameToken();
  }
