...
class CDOut2MAInPlugin : Plugin<Project> {
  ...
  /**
   * Makes symbols of cd source set `main`'s compiled models available in MontiArc `test` (these source sets must
   * exist, checked by whether the [org.gradle.api.plugins.JavaPlugin] is applied).
   */
