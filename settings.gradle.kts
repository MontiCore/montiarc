...
dependencyResolutionManagement {
  versionCatalogs {
    create("libs") {
      ...
      library("mc-lsp", "de.monticore.language-server:monticore-language-server-runtime:7.7.0")
      library("mc-grammar", "de.monticore:monticore-grammar:7.7.0")
      library("mc-runtime", "de.monticore:monticore-runtime:7.7.0")
      library("mc-c2mc", "de.monticore:class2mc:7.7.0")
      library("se-groovy", "de.se_rwth.commons:se-commons-groovy:7.7.0")
      library("se-logging", "de.se_rwth.commons:se-commons-logging:7.7.0")
      library("se-utilities", "de.se_rwth.commons:se-commons-utilities:7.7.0")
      library("mc-cd4a", "de.monticore.lang:cd4analysis:7.7.0")
      library("mc-ocl", "de.monticore.lang:ocl:7.7.0")
      library("mc-ocl-ocl2smt", "de.monticore.lang.ocl:ocl2smt:7.7.0")
      library("mc-sc", "de.monticore.lang:statecharts:7.7.0")
      library("mc-fd", "de.monticore.lang:fd-lang:7.7.0")
    }
  }
}
