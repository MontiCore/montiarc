...
include("tooling:plugin-itest:cd4montiarc-dependencies:cd-a")
include("tooling:plugin-itest:cd4montiarc-dependencies:cd-b")
include("tooling:plugin-itest:cd4montiarc-dependencies:mixed-c-with-4ma-dep-to-b")
include("tooling:plugin-itest:cd4montiarc-dependencies:mixed-c-with-cd-dep-to-b")
include("tooling:plugin-itest:cd4montiarc-dependencies:ma-only-c")
include("tooling:plugin-itest:cd4montiarc-dependencies:ma-only-end-consumer")
include("tooling:plugin-itest:cd4montiarc-dependencies:mixed-end-consumer")
include("tooling:plugin-itest:cd4montiarc-dependencies:availability-in-tests")
