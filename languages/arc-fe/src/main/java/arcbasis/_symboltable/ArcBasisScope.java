...
public class ArcBasisScope extends ArcBasisScopeTOP {

  public ArcBasisScope() {
    super();
  }

  public ArcBasisScope(boolean shadowing) {
    super(shadowing);
  }

  public ArcBasisScope(@NotNull IArcBasisScope enclosingScope) {
    super(Preconditions.checkNotNull(enclosingScope));
  }

  public ArcBasisScope(@NotNull IArcBasisScope enclosingScope, boolean shadowing) {
