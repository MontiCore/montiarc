...
public class ComfortableArcScope extends ComfortableArcScopeTOP {

  public ComfortableArcScope() {
    super();
  }

  public ComfortableArcScope(boolean shadowing) {
    super(shadowing);
  }

  public ComfortableArcScope(@NotNull IComfortableArcScope enclosingScope) {
    super(Preconditions.checkNotNull(enclosingScope));
  }

  public ComfortableArcScope(@NotNull IComfortableArcScope enclosingScope, boolean shadowing) {
