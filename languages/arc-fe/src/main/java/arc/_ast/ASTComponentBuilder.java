...
/**
 * Extends the {@link ASTComponentBuilderTOP} with utility functions for easy constructor of
 * {@link ASTComponent} nodes.
 */
public class ASTComponentBuilder extends ASTComponentBuilderTOP {
  
  protected ASTComponentBuilder() {
    super();
  }
   ...
   */
  public ASTComponentBuilder setInstance(int index, String instance) {
   ...
   * @return this builder
   */
  public ASTComponentBuilder setInstanceList(String... instances) {
   ...
   * @see List#add(Object)
   */
  public ASTComponentBuilder addInstance(String instance) {
    Preconditions.checkNotNull(instance);
    Preconditions.checkArgument(!instance.contains("."));
   ...
   */
  public ASTComponentBuilder addAllInstances(String... instances) {
   ...
   */
  public ASTComponentBuilder addInstance(int index, String instance) {
    Preconditions.checkArgument(index >= 0);
    Preconditions.checkNotNull(instance);
    Preconditions.checkArgument(!instance.contains("."));
   ...
   */
  public ASTComponentBuilder addAllInstances(int index, String... instances) {
    Preconditions.checkArgument(index >= 0);
    Preconditions.checkNotNull(instances);
