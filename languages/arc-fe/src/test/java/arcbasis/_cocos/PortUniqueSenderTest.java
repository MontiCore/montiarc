  ...
  static Stream<Arguments> componentAndErrorCodeProvider() {
    ASTComponentType comp1 = ArcBasisMill. componentTypeBuilder().setName("Comp1")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o1").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i2").setTargetList("o1").build())
        .build())
      .build();
    ...
    ASTComponentType comp2 = ArcBasisMill. componentTypeBuilder().setName("Comp2")
      .setHead(Mockito.mock(ASTComponentHead.class))
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o2").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o2").build())
        .build())
      .build();
    ...
    ASTComponentType comp3 = ArcBasisMill. componentTypeBuilder().setName("Comp3")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o1").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i2").setTargetList("o2").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i3").setTargetList("o3", "o2").build())
        .build())
      .build();
    ...
    ASTComponentType comp4 = ArcBasisMill. componentTypeBuilder().setName("Comp4")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o1").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o2").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i2").setTargetList("o3", "o4").build())
        .build())
      .build();
