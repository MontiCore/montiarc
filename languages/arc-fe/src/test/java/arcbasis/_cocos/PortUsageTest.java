  ...
  static Stream<Arguments> componentAndErrorCodeProvider() {
    ...
    ASTComponentType comp1 = ArcBasisMill.componentTypeBuilder().setName("Comp1")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i1").setTargetList("o1", "o2").build())
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("i2").setTargetList("o3", "i3").build())
        .build())
      .build();
    symTab.handle(comp1);
    ASTComponentType comp2 = ArcBasisMill.componentTypeBuilder().setName("Comp2")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElements(ArcBasisMill.connectorBuilder().setSource("o2").setTargetList("o3").build())
        .build())
      .build();
    symTab.handle(comp2);
