...
public class ComponentTest extends AbstractTest {
    ...
    return ArcBasisMill.componentTypeBuilder().setName("Connectors")
      ...
      .setBody(
        ArcBasisMill.componentBodyBuilder().addArcElement(ArcBasisMill.componentInterfaceBuilder()
          .setPortList(Collections.singletonList(ArcBasisMill.portDeclarationBuilder()
  ...
  private ASTComponentType getInstancesTestComponent() {
    ...
    return ArcBasisMill.componentTypeBuilder().setName("Instances")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElement(ArcBasisMill.componentInstantiationBuilder()
          .setType(Mockito.mock(ASTMCObjectType.class)).setComponentInstanceList("a1").build())
        .addArcElement(ArcBasisMill.componentTypeBuilder().setName("A")
          .setBody(ArcBasisMill.componentBodyBuilder().build())
          .setHead(ArcBasisMill.componentHeadBuilder().build())
          .build())
        .addArcElement(ArcBasisMill.componentInstantiationBuilder()
          .setType(Mockito.mock(ASTMCObjectType.class)).setComponentInstanceList("a2").build())
        .addArcElement(ArcBasisMill.componentInstantiationBuilder()
          .setType(Mockito.mock(ASTMCObjectType.class)).setComponentInstanceList("a3", "a4", "a5")
          .build())
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElement(ArcBasisMill.componentTypeBuilder().setName("C")
          .setHead(ArcBasisMill.componentHeadBuilder()
            .setParameterList(Collections.singletonList(ArcBasisMill.arcParameterBuilder()
              .setType(Mockito.mock(ASTMCObjectType.class))
              .setName("c")
              .build()))
            .build())
  ...
  private ASTComponentType getVariablesTestComponent() {
    return ArcBasisMill.componentTypeBuilder()
      ...
      .setHead(ArcBasisMill.componentHeadBuilder().build())
      .setBody(ArcBasisMill.componentBodyBuilder()
        .addArcElement(ArcBasisMill.componentInterfaceBuilder().setPortList(
        ...
        .addArcElement(ArcBasisMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .addField("a", Mockito.mock(ASTExpression.class)).build())
        .addArcElement(ArcBasisMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .addField("b", Mockito.mock(ASTExpression.class))
          .addField("c", Mockito.mock(ASTExpression.class))
          .build())
        .addArcElement(ArcBasisMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .addField("d", Mockito.mock(ASTExpression.class))
          .addField("e", Mockito.mock(ASTExpression.class))
          .addField("f", Mockito.mock(ASTExpression.class))
          .addField("g", Mockito.mock(ASTExpression.class))
          .build())
        .addArcElement(ArcBasisMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .addField("h", Mockito.mock(ASTExpression.class))
          .addField("i", Mockito.mock(ASTExpression.class))
          .build())
        .addArcElement(ArcBasisMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .addField("o", Mockito.mock(ASTExpression.class))
          .build()).build()).build();
  }
