    ...
    return ArcBasisMill.componentTypeBuilder().setName("Connectors")
      ...
      .setBody(
        ArcBasisMill.componentBodyBuilder().addArcElements(ArcBasisMill.componentInterfaceBuilder()
          ...
          .addArcElements(ArcBasisMill.connectorBuilder()
  ...
  private ASTComponentType getInstancesTestComponent() {
    ...
    return ArcBasisMill.componentTypeBuilder().setName("Instances")
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElements(ArcBasisMill.componentTypeBuilder().setName("A")
        ...
        .addArcElements(ArcBasisMill.componentInstantiationBuilder()
          ...
          .build())
        .addArcElements(ArcBasisMill.componentTypeBuilder().setName("B")
          .setComponentInstanceList("b1", "b2")
          .setBody(ArcBasisMill.componentBodyBuilder().build())
          .setHead(ArcBasisMill.componentHeadBuilder().build())
          .build())
        .addArcElements(ArcBasisMill.componentTypeBuilder().setName("C")
    ...
    return ArcBasisMill.componentTypeBuilder()
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElements(ArcBasisMill.componentTypeBuilder().setName("C")
          ...
          .setBody(ArcBasisMill.componentBodyBuilder().build())
          .build())
        .addArcElements(ArcBasisMill.componentTypeBuilder().setName("D")
  ...
  private ASTComponentType getVariablesTestComponent() {
    return ArcBasisMill.componentTypeBuilder()
      ...
      .setBody(ArcBasisMill.componentBodyBuilder()
        ...
        .addArcElements(ArcBasisMill.arcFieldDeclarationBuilder()
          .setMCType(Mockito.mock(ASTMCType.class))
