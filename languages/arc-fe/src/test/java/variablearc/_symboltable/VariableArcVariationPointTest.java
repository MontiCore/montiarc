...
public class VariableArcVariationPointTest extends AbstractTest {
  ...
  public void shouldAddChild() {
    ...
    Assertions.assertEquals(1, this.getVariationPoint().getChildVariationPoints().size());
    Assertions.assertTrue(this.getVariationPoint().getChildVariationPoints().contains(child));
  }
