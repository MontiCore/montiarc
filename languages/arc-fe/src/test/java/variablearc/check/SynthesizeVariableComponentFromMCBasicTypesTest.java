...
public class SynthesizeVariableComponentFromMCBasicTypesTest extends AbstractTest {
  ...
  public void shouldHandleMCQualifiedType() {
    ...
    ComponentTypeSymbol normalComp = VariableArcMill.componentTypeSymbolBuilder().setName(normalCompName).setSpannedScope(VariableArcMill.scope()).build();
    ...
    ComponentTypeSymbol qualifiedComp = VariableArcMill.componentTypeSymbolBuilder().setName(qualifiedCompName).setSpannedScope(VariableArcMill.scope()).build();
    ...
    Assertions.assertTrue(result4normal.getCurrentResult().get() instanceof TypeExprOfVariableComponent);
    Assertions.assertTrue(result4qual.getCurrentResult().get() instanceof TypeExprOfVariableComponent);
