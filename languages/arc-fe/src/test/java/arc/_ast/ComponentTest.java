      ...
      .setBody(ArcMill.componentBodyBuilder()
        ...
        .addArcElement(ArcMill.componentBuilder().setName("C")
          .setHead(ArcMill.componentHeadBuilder()
            .setParameterList(Collections.singletonList(ArcMill.arcParameterDeclarationBuilder()
              .setType(Mockito.mock(ASTMCObjectType.class))
              .setArcParameter(ArcMill.arcParameterBuilder().setName("c").build())
              .build()))
            .build())
          .setBody(ArcMill.componentBodyBuilder().build())
          .build())
  ...
  private ASTComponent getVariablesTestComponent() {
    return ArcMill.componentBuilder()
      ...
      .setBody(ArcMill.componentBodyBuilder()
        ...
        .addArcElement(ArcMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .setFieldList("a").build())
        .addArcElement(ArcMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .setFieldList("b", "c").build())
        .addArcElement(ArcMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .setFieldList("d", "e", "f", "g").build())
        .addArcElement(ArcMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .setFieldList("h", "i").build())
        .addArcElement(ArcMill.arcFieldDeclarationBuilder()
          .setType(Mockito.mock(ASTMCType.class))
          .setFieldList("o").build()).build()).build();
  }
