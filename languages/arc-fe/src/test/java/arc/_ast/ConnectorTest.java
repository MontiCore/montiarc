...
public class ConnectorTest extends AbstractTest {
  ...
  static ASTConnector getFirstTestConnector() {
    return ArcMill.connectorBuilder().setSource("i1").setTargetList("o1", "comp1.i1").build();
  }

  static ASTConnector getSecondTestConnector() {
    return ArcMill.connectorBuilder().setSource("comp1.o1").setTargetList("o1", "comp2.i1").build();
  }
}