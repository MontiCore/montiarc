...
public class ComponentBuilderTest extends AbstractTest {
  ...
  public void shouldAddGivenInstance(String instance) {
    ...
    ASTComponent ast = this.builder.addInstance(instance).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
  ...
  public void shouldSetGivenInstance(int index, String instance) {
    ...
    ASTComponent ast = this.builder.setInstance(index, instance).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(ast.getInstance(index).getName(), instance);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
    Assertions.assertEquals(expectedInstanceList, actualInstanceList);
  }
  ...
  public void shouldAddGivenInstance(int index, String instance) {
    ...
    ASTComponent ast = this.builder.addInstance(index, instance).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(ast.getInstance(index).getName(), instance);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
    Assertions.assertEquals(expectedInstanceList, actualInstanceList);
  ...
  public void shouldSetGivenInstances(String[] instances) {
    ...
    ASTComponent ast = this.builder.setInstanceList(instances).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
    Assertions.assertEquals(expectedInstanceList, actualInstanceList);
  }
  ...
  public void shouldAddGivenInstances(String[] instances) {
    ...
    ASTComponent ast = this.builder.addAllInstances(instances).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
    Assertions.assertEquals(expectedInstanceList, actualInstanceList);
  }
  ...
  public void shouldAddGivenInstances(int index, String[] instances) {
    ...
    ASTComponent ast = this.builder.addAllInstances(index, instances).build();
    List<String> actualInstanceList = this.getInstanceList(ast);
    Assertions.assertEquals(expectedInstanceList.size(), ast.getInstanceList().size());
    Assertions.assertEquals(expectedInstanceList, actualInstanceList);
  }
  ...
  protected List<String> getInstanceList(ASTComponentBuilder builder) {
    return builder.getInstanceList().stream()
      .map(ASTComponentInstance::getName)
      .collect(Collectors.toList());
  }

  protected List<String> getInstanceList(ASTComponent ast) {
    return ast.getInstanceList().stream().map(ASTComponentInstance::getName)
      .collect(Collectors.toList());
  }
}