...
public class CD4AModelLoader extends CD4AnalysisModelLoader {
  ...
  @Override
  protected void createSymbolTableFromAST(ASTCDCompilationUnit arg0, String arg1, MutableScope arg2,
      ResolvingConfiguration arg3) {
    super.createSymbolTableFromAST(arg0, arg1, arg2, arg3);
    new CD4ACoCos().getCheckerForAllCoCos().checkAll(arg0); // perform coco check after SymTab
                                                            // creation
  }
