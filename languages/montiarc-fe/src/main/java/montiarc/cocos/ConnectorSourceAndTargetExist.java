 ...
 * @implements [Hab16] CO3: Unqualified sources or targets in connectors either refer to a port
 * or a subcomponent in the same namespace. (p.61 Lst. 3.35)
 * @implements [Hab16] R5: The first part of a qualified connector’s source respectively target must correspond to a subcomponent declared in the current component definition. (p.64 Lst. 3.40)
