...
public class MontiArc4OOSymbolDeSer extends OOSymbolsDeSer implements IDeSer<IOOSymbolsScope, IOOSymbolsArtifactScope, OOSymbolsSymbols2Json> {

  @Override
  public void deserializeAddons(@NotNull IOOSymbolsScope scope, @NotNull JsonObject scopeJson) {
  ...
  @Override
  public void deserializeAddons(@NotNull IOOSymbolsArtifactScope scope, @NotNull JsonObject scopeJson) {
    Preconditions.checkNotNull(scope);
    Preconditions.checkNotNull(scopeJson);
    this.doDeserializeAddons(scope, scopeJson);
  }
