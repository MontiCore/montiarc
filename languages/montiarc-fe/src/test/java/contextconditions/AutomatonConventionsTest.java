...
public class AutomatonConventionsTest extends AbstractCoCoTest {
  ...
  public void testLowerCaseAutomatonName() {
    ...
    checkInvalid(MontiArcCoCos.createChecker(), node, new ExpectedErrorInfo(1, "xMA049"));
  }

  @Test
  public void testImplementationInNonAtomicComponent() {
    checkInvalid(MontiArcCoCos.createChecker(), getAstNode("", "contextconditions.invalid.ImplementationInNonAtomicComponent"), new ExpectedErrorInfo(1, "xMA051"));
  }
  ...
  public void testInvalidImports() {
    ...
    checkInvalid(MontiArcCoCos.createChecker(), node, new ExpectedErrorInfo(1,"xMA076"));
  ...
  public void testReactionsWithAlternatives() {
    ...
    checkInvalid(MontiArcCoCos.createChecker(),node, new ExpectedErrorInfo(2, "xMA020", "xMA062"));
  }
  ...
  public void testForbiddenExprInstanceOf() {
    ...
    checkInvalid(MontiArcCoCos.createChecker(),node, new ExpectedErrorInfo(1, "xMA023"));
  }
  ...
  public void testMultipleAssignmentsSameIdentifier() {
    ...
    checkInvalid(MontiArcCoCos.createChecker(),node, new ExpectedErrorInfo(3, "xMA019"));
  }
  ...
  public void testAutomatonHasCorrectAssignments(){
    ...
    checkInvalid(MontiArcCoCos.createChecker(),node, new ExpectedErrorInfo(4, "xMA017", "xMA016"));
  }
