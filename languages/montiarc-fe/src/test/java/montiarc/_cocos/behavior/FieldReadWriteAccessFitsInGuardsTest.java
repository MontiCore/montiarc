...
class FieldReadWriteAccessFitsInGuardsTest extends AbstractCoCoTest {
  ...
  protected static Stream<Arguments> modelAndExpectedErrorsProvider() {
    return Stream.of(
      arg("DeepIncrement.arc", BehaviorError.WRITE_TO_INCOMING_PORT, BehaviorError.READ_FROM_OUTGOING_PORT),
      arg("IncrementPort.arc", BehaviorError.WRITE_TO_INCOMING_PORT, BehaviorError.READ_FROM_OUTGOING_PORT),
