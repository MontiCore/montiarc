...
component PortCompatibilityWithGenerics {
  ...
  connect listBoolIn -> myGenComp.myListKIn1;
    // incompatible (List<Boolean> -> List<String>)
  connect listStringIn -> myGenComp.myListKIn2;
    //compatible (List<String> -> List<String>)

  connect listMapIntStringIn -> myGenComp.myListMapKVIn1;
    // incompatible (List<Map<Integer,String> -> List<Map<String,Integer>>)
  connect listMapStringIntIn -> myGenComp.myListMapKVIn2;
    // compatible (List<Map<String,Integer>> -> List<Map<String,Integer>>)

  connect myGenComp.myListKOut -> listBoolOut;
    // incompatible (List<String> -> List<Boolean>)
  connect myGenComp.myListKOut -> listStringOut;
    //compatible (List<String> -> List<String>)

  connect myGenComp.myListMapKVOut -> listMapIntStringOut;
    // incompatible (List<Map<String,Integer> -> List<Map<Integer,String>>)
  connect myGenComp.myListMapKVOut -> listMapStringIntOut;
    // compatible (List<Map<String,Integer>> -> List<Map<String,Integer>>)

  connect listMapStringIntIn -> myGenComp.myListMapKKIn1;
    // incompatible (List<Map<String,Integer> -> List<Map<String,String>>)
  connect listMapStringStringIn -> myGenComp.myListMapKKIn2;
    // compatible (List<Map<String,String> -> List<Map<String,String>>)
  ...
  connect listBoolIn -> myGenComp2.myKIn1;
    // incompatible (List<Boolean> -> List<String>)
  connect listStringIn -> myGenComp2.myKIn2;
    // compatible (List<String> -> List<String>)

  connect listListBoolIn -> myGenComp2.myListKIn1;
    // incompatible (List<List<Boolean>> -> List<List<String>>)
  connect listListStringIn -> myGenComp2.myListKIn2;
    // compatible (List<List<String>> -> List<List<String>>)
  ...
  connect myGenComp2.myListKOut -> out2;
    // compatible List<List<String>> -> List<List<String>>
  connect myGenComp2.myListMapKVOut -> out3;
    // compatible List<Map<List<String>,Integer>> -> List<Map<List<String>, Integer>>
