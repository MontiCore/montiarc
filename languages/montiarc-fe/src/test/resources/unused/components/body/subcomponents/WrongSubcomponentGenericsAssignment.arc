 ...
 * @implements [Hab16] R9: If a generic component type is instantiated as
                              a subcomponent, all generic parameters
                              have to be assigned. (p.66, Lst.3.44)
 *
 * TODO Add Test; Only logs errors concerning unconnected ports. Currently
 *        no type (assignment) checking that produces errors
 */
component WrongSubcomponentGenericsAssignment {
  ...
  component components.body.subcomponents._subcomponents.HasGenericInputAndOutputPort<java.lang.String> pCorrect;
