...
public class AJavaSymbolTableCreator extends CommonSymbolTableCreator
  ...
  public AJavaSymbolTableCreator(final ResolvingConfiguration resolverConfig, final Deque<MutableScope> scopeStack) {
  ...
  private void initSuperSTC(ResolvingConfiguration resolverConfig) {
    ...
    visitor.set_de_monticore_lang_montiarc_montiarcautomaton__visitor_MontiArcAutomatonVisitor(maaSTC);
...
//      
//    }
//    JavaMethodSymbol automaton = new JavaMethodSymbol(node.getName());
