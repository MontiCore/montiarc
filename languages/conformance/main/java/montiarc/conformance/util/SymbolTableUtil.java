...
public class SymbolTableUtil {
  ...
  public static boolean isInPortVar(ISymbol symbol, ASTArcComponentType comp) {
  ...
  public static Optional<PortSymbol> resolvePort(String portName, ASTArcComponentType comp) {
  ...
  public static Optional<VariableSymbol> resolveGlobalVar(String varName, ASTArcComponentType comp) {
  ...
  public static Optional<SCStateSymbol> resolveState(String stateName, ASTArcComponentType comp) {
  ...
  public static ISymbol resolveSymbol(String symbolName, ASTArcComponentType comp) {
