...
/**
 * Represents a reference of {@link BehaviorEmbeddingSymbol}.
 */
public class BehaviorEmbeddingSymbolReference extends BehaviorEmbeddingSymbol implements SymbolReference<BehaviorEmbeddingSymbol> {
  protected final SymbolReference<BehaviorEmbeddingSymbol> reference;

  public BehaviorEmbeddingSymbolReference(final String name, final Scope enclosingScopeOfReference) {
    super(name);
    reference = new CommonSymbolReference<>(name, BehaviorEmbeddingSymbol.KIND, enclosingScopeOfReference);
  }
  ...
  @Override
  public BehaviorEmbeddingSymbol getReferencedSymbol() {
  ...
  */
  ...
  /*
  * Methods of BehaviorEmbeddingSymbol class
  */
