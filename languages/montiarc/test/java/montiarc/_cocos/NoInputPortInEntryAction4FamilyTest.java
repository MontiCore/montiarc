...
/**
 * The class under test is {@link NoInputPortInEntryAction4Family}.
 */
class NoInputPortInEntryAction4FamilyTest extends NoInputPortInEntryActionTest {
  ...
  static Stream<Arguments> validModelsWithVariability() {
    return Stream.of(
      // read value from input port in entry action, dead variation point
      arg("""
      ...
      // read value from input port in entry action, dead feature
      arg("""
      ...
      // read value from conditional input port in entry action
      arg("""
  ...
  static Stream<Arguments> invalidModelsWithVariability() {
    return Stream.of(
      // read value from input port in entry action, tautological variation point
      arg("""
      ...
      // read value from input port in entry action, core feature
      arg("""
