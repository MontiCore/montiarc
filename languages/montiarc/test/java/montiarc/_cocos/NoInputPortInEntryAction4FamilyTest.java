...
public class NoInputPortInEntryAction4FamilyTest extends MontiArcTestBase {
  ...
  @ParameterizedTest
  @ValueSource(strings = {
    // 1 - Write literal to output port in entry action
    "component Comp1 { " +
      "  port out int o; " +
      "  automaton { " +
      "    initial state S { " +
      ...
      "  } " +
      "}",
    // 2 - Write literal to synchronous output port in entry action
    "component Comp2 { " +
      "  port sync out int o; " +
      "  automaton { " +
      "    initial state S { " +
      ...
      "  } " +
      "}",
    // 3 - Write value of component variable to output port in entry action
    "component Comp3 { " +
      "  port out int o; " +
      "  int v = 0; " +
      "  automaton { " +
      ...
      "  } " +
      "}",
    // 4 - Read value from and write to field in entry action
    "import montiarc.test.OOTypeWithFieldIO; " +
      ...
      "  } " +
      "}",
    // 5 - Read value from method call in entry action
    "import montiarc.test.OOTypeWithFunctionIO; " +
      ...
      "  } " +
      "}",
    // 6 - Read value from and write to static field in entry action
    "import montiarc.test.OOTypeWithStaticFieldIO; " +
      ...
      "  } " +
      "}",
    // 7 - Read value from static method call in entry action
    "import montiarc.test.OOTypeWithStaticFunctionIO; " +
      ...
      "  } " +
      "}",
    // 8 - Variable declaration shadows port in entry action
    "component Comp8 { " +
      "  port in int i; " +
      "  port out int o; " +
      "  automaton { " +
      ...
      "  } " +
      "}",
    // 9 - For control shadows port in entry action
    "component Comp9 { " +
      "  port in int i; " +
      "  port out int o; " +
      "  automaton { " +
  ...
  void shouldNotReportErrorWithVariability(@NotNull String model) {
    ...
    MontiArcFullVariantCoCoChecker checker = new MontiArcFullVariantCoCoChecker();
    checker.get4FullVariant().addCoCo(new NoInputPortInEntryAction4Family());
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // 1 - No input port in var declaration statement in entry action
      arg("component Comp1 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 2 - No synchronous input port in var declaration statement in entry action
      arg("component Comp2 { " +
          "  port sync in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 3 - No input port in assignment expressions in entry action
      arg(
        "component Comp3 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 4 - No input port in inc prefix expressions in entry action
      arg(
        "component Comp4 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 5 - No input port in dec prefix expressions in entry action
      arg(
        "component Comp5 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 6 - No input port in inc suffix expressions in entry action
      arg(
        "component Comp6 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 7 - No input port in dec suffix expressions in entry action
      arg(
        "component Comp7 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 8 - No input port in boolean not expressions in entry action
      arg(
        "component Comp8 { " +
          "  port in boolean i; " +
          "  automaton { " +
      ...
      // 9 - No input port in logical not expressions in entry action
      arg(
        "component Comp9 { " +
          "  port in boolean i; " +
          "  automaton { " +
      ...
      // 10 - No input port in multiply expressions (right) in entry action
      arg(
        "component Comp10 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 11 - No input port in multiply expressions (left) in entry action
      arg(
        "component Comp11 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 12 - No input port in multiply expressions (both) in entry action
      arg(
        "component Comp12 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 13 - No input port in infix expressions in entry action
      arg(
        "component Comp13 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 14 - No input port in conditional expressions (condition) in entry action
      arg(
        "component Comp14 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 15 - No input port in conditional expressions (then) in entry action
      arg(
        "component Comp15 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 16 - No input port in conditional expressions (else) in entry action
      arg(
        "component Comp16 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 17 - No input port in bracket expressions in entry action
      arg(
        "component Comp17 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 18 - No input port in shift expressions in entry action
      arg(
        "component Comp18 { " +
          "  port in int i; " +
          "  automaton { " +
      ...
      // 19 - No input port in binary expressions in entry action
      arg(
        "component Comp19 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 20 - No input port in if statement (condition) in entry action
      arg(
        "component Comp20 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 21 - No input port in if statement (then) in entry action
      arg(
        "component Comp21 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 22 - No input port in if statement (else) in entry action
      arg(
        "component Comp22 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 23 - No input port in common for control (var dec) in entry action
      arg(
        "component Comp23 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 24 - No input port in common for control (var assignment) in entry action
      arg(
        "component Comp24 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 25 - No input port in common for control (condition) in entry action
      arg(
        "component Comp25 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 26 - No input port in common for control (expression) in entry action
      arg(
        "component Comp26 { " +
          "  port in boolean i;" +
          "  automaton { " +
      ...
      // 27 - No input port in common for control (second expression) in entry action
      arg(
        "component Comp27 { " +
          "  port in boolean i;" +
          "  automaton { " +
