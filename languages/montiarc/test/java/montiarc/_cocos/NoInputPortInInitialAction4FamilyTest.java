...
public class NoInputPortInInitialAction4FamilyTest extends MontiArcTestBase {
  ...
  public void TestModelRuntimeMontiArcCoCos(@NotNull String model) {
    ...
    checker.get4FullVariant().addCoCo(new NoInputPortInInitialAction4Family());
  ...
  @ParameterizedTest
  @ValueSource(strings = {
    // 1 - Write literal to output port in initial action
    "component Comp1 { " +
      "  port out int o; " +
      "  automaton { " +
      "    initial { o = 0; } " +
      ...
      "  } " +
      "}",
    // 2 - Write literal to synchronous output port in initial action
    "component Comp2 { " +
      "  port sync out int o; " +
      "  automaton { " +
      "    initial { o = 0; } " +
      ...
      "  } " +
      "}",
    // 3 - Write value of component variable to output port in initial action
    "component Comp3 { " +
      "  port out int o; " +
      "  int v = 0; " +
      "  automaton { " +
      ...
      "  } " +
      "}",
    // 4 - Read value from and write to field in initial action
    "import montiarc.test.OOTypeWithFieldIO; " +
      ...
      "  } " +
      "}",
    // 5 - Read value from method call in initial action
    "import montiarc.test.OOTypeWithFunctionIO; " +
      ...
      "  } " +
      "}",
    // 6 - Read value from and write to static field in initial action
    "import montiarc.test.OOTypeWithStaticFieldIO; " +
      ...
      "  } " +
      "}",
    // 7 - Read value from static method call in initial action
    "import montiarc.test.OOTypeWithStaticFunctionIO; " +
      ...
      "  } " +
      "}",
    // 8 - Variable declaration shadows port in initial action
    "component Comp8 { " +
      "  port in int i; " +
      "  port out int o; " +
      "  automaton { " +
      ...
      "  } " +
      "}",
    // 9 - For control shadows port in initial action
    "component Comp9 { " +
      "  port in int i; " +
      "  port out int o; " +
      "  automaton { " +
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // 1 - No input port in var declaration statement in init action
      arg("component Comp1 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 2 - No synchronous input port in var declaration statement in init action
      arg("component Comp2 { " +
          "  port sync in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 3 - No input port in assignment expressions in init action
      arg("component Comp3 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 4 - No input port in inc prefix expressions in init action
      arg("component Comp4 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 5 - No input port in dec prefix expressions in init action
      arg("component Comp5 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 6 - No input port in inc suffix expressions in init action
      arg("component Comp6 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 7 - No input port in dec suffix expressions in init action
      arg("component Comp7 { " +
          "  port in int i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 8 - No input port in boolean not expressions in init action
      arg("component Comp8 { " +
          "  port in boolean i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 9 - No input port in logical not expressions in init action
      arg("component Comp9 { " +
          "  port in boolean i; " +
          "  automaton { " +
          "    initial { " +
      ...
      // 10 - No input port in multiply expressions (right) in init action
      ...
      // 11 - No input port in multiply expressions (left) in init action
      ...
      // 12 - No input port in multiply expressions (both) in init action
      ...
      // 13 - No input port in infix expressions in init action
      ...
      // 14 - No input port in conditional expressions (condition) in init action
      ...
      // 15 - No input port in conditional expressions (then) in init action
      ...
      // 16 - No input port in conditional expressions (else) in init action
      ...
      // 17 - No input port in bracket expressions in init action
      ...
      // 18 - No input port in shift expressions in init action
      ...
      // 19 - No input port in binary expressions in init action
      ...
      // 20 - No input port in if statement (condition) in init action
      ...
      // 21 - No input port in if statement (then) in init action
      ...
      // 22 - No input port in if statement (else) in init action
      ...
      // 23 - No input port in common for control (var dec) in init action
      ...
      // 24 - No input port in common for control (var assignment) in init action
      ...
      // 25 - No input port in common for control (condition) in init action
      ...
      // 26 - No input port in common for control (expression) in init action
      ...
      // 27 - No input port in common for control (second expression) in init action
