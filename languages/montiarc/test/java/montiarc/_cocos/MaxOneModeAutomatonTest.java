 ...
 */
public class MaxOneModeAutomatonTest extends MontiArcAbstractTest {
  ...
  @ValueSource(strings = {
    ...
    "component Comp6 { }",
    // atomic component with two modes
    "component Comp7 { " +
      "mode automaton { } " +
      "mode automaton { } " +
      "}",
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // decomposed with two automata
      arg("component Comp1 { " +
          "a.b.A a;" +
          "mode automaton { } " +
          "mode automaton { } " +
          "}",
        ModesError.MULTIPLE_MODE_AUTOMATA),
      // inner with two mode automata
      arg("component Comp2 { " +
          "component Inner { " +
          "a.b.A a;" +
          "mode automaton { } " +
