...
public class SubcomponentNoReservedKeywordTest extends AbstractCoCoTest {
  ...
  protected void registerCoCos(MontiArcCoCoChecker checker) {
    checker.addCoCo(new SubcomponentNoReservedKeyword("testLang", provideKeywords()));
  }

  protected static Stream<Arguments> modelAndExpectedErrorProvider() {
    return Stream.of(
      arg("InstanceNamesAreLegal.arc"),
      arg("InstanceNamesAreKeywords.arc",  // Expect 4 violations
