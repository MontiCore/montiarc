 ...
 */
class TypeParamNameIsNoReservedKeywordTest extends MontiArcTestBase {
  ...
  @ValueSource(strings = {
    ...
    // regular generic type parameter, no reserved keyword involved
    "component ValidComp4<T> { }",
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // single generic type parameter named after the first reserved keyword
      arg("component InvalidComp1<key> { }",
        RESTRICTED_IDENTIFIER),
      // single generic type parameter named after the second reserved keyword
      arg("component InvalidComp2<word> { }",
        RESTRICTED_IDENTIFIER),
      // two generic type parameters, one regular and one named after the keyword
      arg("component InvalidComp3<T, key> { }",
        RESTRICTED_IDENTIFIER),
      // two generic type parameters, both named after the same reserved keyword
      arg("component InvalidComp4<key, key> { }",
        RESTRICTED_IDENTIFIER,
        RESTRICTED_IDENTIFIER)
    );
  }
