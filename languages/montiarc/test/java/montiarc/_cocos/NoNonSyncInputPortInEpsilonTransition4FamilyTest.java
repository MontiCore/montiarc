...
public class NoNonSyncInputPortInEpsilonTransition4FamilyTest extends MontiArcTestBase {
  ...
  public void TestModelRuntimeMontiArcCoCos(@NotNull String model) {
    ...
    checker.get4FullVariant().addCoCo(new NoNonSyncInputPortInEpsilonTransition4Family());
  ...
  @ValueSource(strings = {
    ...
    "import montiarc.test.OOTypeWithFieldIO; " +
      ...
      "  port out int o; }" +
      "varif(f2){}else{  OOTypeWithFieldIO v = OOTypeWithFieldIO.OOTypeWithFieldIO(); " +
      "  automaton { " +
      "    state S; " +
      "    S -> S / { " +
      "      o = v.i; o = v.o; " +
