...
/**
 * The class under test is {@link NoNonSyncInputPortInCompute4Family}.
 */
class NoNonSyncInputPortInCompute4FamilyTest extends NoNonSyncInputPortInComputeTest {
  ...
  static Stream<Arguments> validModelsWithVariability() {
    return Stream.of(
      // read value from non-synchronous input port in compute block, dead variation point
      arg("""
      ...
      // read value from non-synchronous input port in compute block, dead feature
      arg("""
      ...
      // read value from conditional non-synchronous input port in compute block
      arg("""
  ...
  static Stream<Arguments> invalidModelsWithVariability() {
    return Stream.of(
      // read value from non-synchronous input port in compute block, tautological variation point
      arg("""
      ...
      // read value from non-synchronous input port in compute block, core feature
      arg("""
