...
/**
 * The class under test is {@link NoInputPortsInInitialCompute4Family}.
 */
class NoInputPortsInInitialCompute4FamilyTest extends NoInputPortsInInitialComputeTest {
  ...
  static Stream<Arguments> validModelsWithVariability() {
    return Stream.of(
      // read value from input port in init block, dead variation point
      arg("""
      ...
      // read value from input port in init block, dead feature
      arg("""
      ...
      // read value from conditional input port in init block
      arg("""
  ...
  static Stream<Arguments> invalidModelsWithVariability() {
    return Stream.of(
      // read value from input port in init block, tautological variation point
      arg("""
      ...
      // read value from input port in init block, core feature
      arg("""
