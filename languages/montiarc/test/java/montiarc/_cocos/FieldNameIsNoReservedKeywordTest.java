 ...
 */
public class FieldNameIsNoReservedKeywordTest extends MontiArcAbstractTest {
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      arg("component Comp1 { int key = 1; }",
        ArcError.RESTRICTED_IDENTIFIER),
      arg("component Comp2 { int word = 1; }",
        ArcError.RESTRICTED_IDENTIFIER),
      arg("component Comp3 { int key = 1; int key = 2; }",
        ArcError.RESTRICTED_IDENTIFIER,
        ArcError.RESTRICTED_IDENTIFIER)
    );
  }
