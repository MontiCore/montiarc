...
public class ComponentInheritanceRespectsGenericTypeBoundsTest extends AbstractCoCoTest {

  protected static final String PACKAGE = "componentInheritanceRespectsGenericTypeBounds";
  ...
  public void loadComponentsToInstantiate() {
    ...
    this.parseAndCreateAndCompleteSymbols("parents/GenericComp.arc");
    this.parseAndCreateAndCompleteSymbols("parents/CompWithoutTypeArgs.arc");
  }
  ...
  @ParameterizedTest
  @ValueSource(strings = {
    "CompatibleBounds.arc", "CompatibleBoundsInGenericHead.arc",
    "InheritsFromCompWithoutTypeArgs.arc","InheritsFromCompWithoutTypeArgsInGenericHead.arc"
  })
  ...
  protected static Stream<Arguments> modelAndExpectedErrorsProvider() {
    return Stream.of(
      ...
      arg("IncompatibleBoundsInGenericHead.arc",
        GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND, GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND,
        GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND, GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND,
        GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND, GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND,
        GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND, GenericArcError.TYPE_ARG_IGNORES_UPPER_BOUND,
