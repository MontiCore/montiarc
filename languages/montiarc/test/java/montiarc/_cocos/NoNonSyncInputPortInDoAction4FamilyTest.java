...
public class NoNonSyncInputPortInDoAction4FamilyTest extends MontiArcTestBase {
  ...
  private static Stream<Arguments> provideUniqueSenderModel() {
    ...
    Arguments simpleModel = arg("component Comp22 { " +
      "  port out int o; " +
  ...
  public void TestModelRuntimeMontiArcCoCos(@NotNull String model) {
    ...
    checker.get4FullVariant().addCoCo(new NoNonSyncInputPortInDoAction4Family());
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // 1 - No non-synchronous input port in var declaration statement in do action
      arg("component Comp1 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 2 - No non-synchronous input port in assignment expressions in do action
      arg("component Comp2 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 3 - No non-synchronous input port in inc prefix expressions in do action
      arg("component Comp3 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 4 - No non-synchronous input port in dec prefix expressions in do action
      arg("component Comp4 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 5 - No non-synchronous input port in inc suffix expressions in do action
      arg("component Comp5 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 6 - No non-synchronous input port in dec suffix expressions in do action
      arg("component Comp6 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 7 - No non-synchronous input port in boolean not expressions in do action
      arg("component Comp7 { " +
          "  port in boolean i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 8 - No non-synchronous input port in logical not expressions in do action
      arg("component Comp8 { " +
          "  port in boolean i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 9 - No non-synchronous input port in multiply expressions (right) in do action
      arg("component Comp9 { " +
          "  port in int i; " +
          "  automaton { " +
          "    state S { " +
      ...
      // 10 - No non-synchronous input port in multiply expressions (left) in do action
      ...
      // 11 - No non-synchronous input port in multiply expressions (both) in do action
      ...
      // 12 - No non-synchronous input port in multiply expressions (both) in do action
      ...
      // 13 - No non-synchronous input port in infix expressions in do action
      ...
      // 14 - No non-synchronous input port in conditional expressions (condition) in do action
      ...
      // 15 - No non-synchronous input port in conditional expressions (then) in do action
      ...
      // 16 - No non-synchronous input port in conditional expressions (else) in do action
      ...
      // 17 - No non-synchronous input port in bracket expressions in do action
      ...
      // 18 - No non-synchronous input port in shift expressions in do action
      ...
      // 19 - No non-synchronous input port in binary expressions in do action
      ...
      // 20 - No non-synchronous input port in if statement (condition) in do action
      ...
      // 21 - No non-synchronous input port in if statement (then) in do action
      ...
      // 22 - No non-synchronous input port in if statement (else) in do action
      ...
      // 23 - No non-synchronous input port in common for control (var dec) in do action
      ...
      // 24 - No non-synchronous input port in common for control (var assignment) in do action
      ...
      // 25 - No non-synchronous input port in common for control (condition) in do action
      ...
      // 26 - No non-synchronous input port in common for control (expression) in do action
      ...
      // 27 - No non-synchronous input port in common for control (expression) in do action
