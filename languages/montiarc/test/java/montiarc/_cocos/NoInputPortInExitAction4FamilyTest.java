...
/**
 * The class under test is {@link NoInputPortInExitAction4Family}.
 */
class NoInputPortInExitAction4FamilyTest extends NoInputPortInExitActionTest {
  ...
  static Stream<Arguments> validModelsWithVariability() {
    return Stream.of(
      // read value from input port in exit action, dead variation point
      arg("""
      ...
      // read value from input port in exit action, dead feature
      arg("""
      ...
      // read value from conditional input port in exit action
      arg("""
  ...
  static Stream<Arguments> invalidModelsWithVariability() {
    return Stream.of(
      // read value from input port in exit action, tautological variation point
      arg("""
      ...
      // read value from input port in exit action, core feature
      arg("""
