 ...
 */
class ParameterNoReservedKeywordTest extends MontiArcTestBase {
  ...
  @ValueSource(strings = {
    ...
    // regular parameter, no reserved keyword involved
  ...
  protected static Stream<Arguments> invalidModels() {
    return Stream.of(
      // single parameter named after the first reserved keyword
      arg("component InvalidComp1(int key) { }",
        RESTRICTED_IDENTIFIER),
      // single parameter named after the second reserved keyword
      arg("component InvalidComp2(int word) { }",
        RESTRICTED_IDENTIFIER),
      // two parameters, one regular and one named after the keyword
      arg("component InvalidComp3(int p, int key) { }",
        RESTRICTED_IDENTIFIER),
      // two parameters, both named after the same reserved keyword
      arg("component InvalidComp4(int key, int key) { }",
        RESTRICTED_IDENTIFIER,
        RESTRICTED_IDENTIFIER)
    );
  }
