...
public class ComponentTypeNameIsNoReservedKeywordTest extends AbstractCoCoTest {
  ...
  protected void registerCoCos(MontiArcCoCoChecker checker) {
    checker.addCoCo(new ComponentTypeNameIsNoReservedKeyword("testLang", provideKeywords()));
  }
