...
public class TypeCheckCollectionsTest extends MontiArcAbstractTest {
  ...
  @CsvSource(value = {
    ...
    "listOfBool = [ 'a' ], 0xA0179", // expected List<boolean> but provided List<char>
    "listOfBool = [ 1 ], 0xA0179", // expected List<boolean> but provided List<int>
    "listOfBool = [ 1l ], 0xA0179", // expected List<boolean> but provided List<long>
    "listOfBool = [ 1.0f ], 0xA0179", // expected List<boolean> but provided List<float>
    "listOfBool = [ 1.0 ], 0xA0179", // expected List<boolean> but provided List<double>
    "setOfBool = { 'a' }, 0xA0179", // expected Set<boolean but provided Set<char>
    "setOfBool = { 1 }, 0xA0179", // expected Set<boolean but provided Set<int>
    "setOfBool = { 1l }, 0xA0179", // expected Set<boolean but provided Set<long>
    "setOfBool = { 1.0f }, 0xA0179", // expected Set<boolean> but provided Set<float>
    "setOfBool = { 1.0 }, 0xA0179", // expected Set<boolean> but provided Set<double>
    "setOfBool = Set { 'a' }, 0xA0179", // expected Set<boolean but provided Set<char>
    "setOfBool = Set { 1 }, 0xA0179", // expected Set<boolean but provided Set<int>
    "setOfBool = Set { 1l }, 0xA0179", // expected Set<boolean but provided Set<long>
    "setOfBool = Set { 1.0f }, 0xA0179", // expected Set<boolean> but provided Set<float>
    "setOfBool = Set { 1.0 }, 0xA0179", // expected Set<boolean> but provided Set<double>
  })
