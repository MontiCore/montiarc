...
public class PortReadWriteInCompute4MontiArc extends PortReadWriteInCompute {

  public PortReadWriteInCompute4MontiArc() {
   ...
   */
  protected PortReadWriteInCompute4MontiArc(@NotNull MontiArcTraverser t,
