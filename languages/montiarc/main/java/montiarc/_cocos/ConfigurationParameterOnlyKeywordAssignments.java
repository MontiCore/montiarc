 ...
 */
public class ConfigurationParameterOnlyKeywordAssignments implements ArcBasisASTComponentInstanceCoCo {
  ...
  public void check(@NotNull ASTComponentInstance instance) {
    ...
    for (ASTExpression arg : instantiationArgs) {
      ...
      if (visitor.hasAssignment()) {
        Log.error(ArcError.INSTANTIATION_ARGUMENT_INVALID_ASSIGNMENT.format(
          instance.getName()), arg.get_SourcePositionStart(), arg.get_SourcePositionEnd());
      }
      visitor.reset();
    }
  }
