...
import arcautomaton._cocos.PortReadWriteInDoAction;
...
public class PortReadWriteInDoAction4FamilyCollector extends PortReadWriteInDoAction {
  ...
  public PortReadWriteInDoAction4FamilyCollector() {
   ...
   */
  protected PortReadWriteInDoAction4FamilyCollector(@NotNull MontiArcTraverser t,
