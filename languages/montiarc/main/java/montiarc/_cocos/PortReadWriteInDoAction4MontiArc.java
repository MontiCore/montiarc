...
public class PortReadWriteInDoAction4MontiArc extends PortReadWriteInDoAction {

  public PortReadWriteInDoAction4MontiArc() {
   ...
   */
  protected PortReadWriteInDoAction4MontiArc(@NotNull MontiArcTraverser t,
