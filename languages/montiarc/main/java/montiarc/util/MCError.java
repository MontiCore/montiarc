...
public enum MCError implements Error {
  ...
  AMBIGUOUS_COMPONENT_REFERENCE("0xD0105", "Ambiguous reference, both '%s' and '%s' match'"),
  AMBIGUOUS_MCPATH_ENTRIES("0xA1294", "The following entries for the file %s are ambiguous: \n%s");
