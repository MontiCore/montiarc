...
/**
 * Represents a reference of {@link AutomatonSymbol}.
 */
public class AutomatonSymbolReference extends AutomatonSymbol implements SymbolReference<AutomatonSymbol> {
  protected final SymbolReference<AutomatonSymbol> reference;

  public AutomatonSymbolReference(final String name, final Scope enclosingScopeOfReference) {
    super(name);
    reference = new CommonSymbolReference<>(name, AutomatonSymbol.KIND, enclosingScopeOfReference);
  }
  ...
  @Override
  public AutomatonSymbol getReferencedSymbol() {
  ...
  */
  ...
  /*
  * Methods of AutomatonSymbol class
  */
