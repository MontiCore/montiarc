...
/**
 * Represents a reference of {@link InitialStateDeclarationSymbol}.
 */
public class InitialStateDeclarationSymbolReference extends InitialStateDeclarationSymbol implements SymbolReference<InitialStateDeclarationSymbol> {
  protected final SymbolReference<InitialStateDeclarationSymbol> reference;

  public InitialStateDeclarationSymbolReference(final String name, final Scope enclosingScopeOfReference) {
    super(name);
    reference = new CommonSymbolReference<>(name, InitialStateDeclarationSymbol.KIND, enclosingScopeOfReference);
  }
  ...
  @Override
  public InitialStateDeclarationSymbol getReferencedSymbol() {
  ...
  */
  ...
  /*
  * Methods of InitialStateDeclarationSymbol class
  */
