...
/**
 * Represents a reference of {@link StateSymbol}.
 */
public class StateSymbolReference extends StateSymbol implements SymbolReference<StateSymbol> {
  protected final SymbolReference<StateSymbol> reference;

  public StateSymbolReference(final String name, final Scope enclosingScopeOfReference) {
    super(name);
    reference = new CommonSymbolReference<>(name, StateSymbol.KIND, enclosingScopeOfReference);
  }
