...
public enum ArcError implements Error {
  ...
  IN_PORT_DELAYED("0xC1115", "Annotation error, cannot delay incoming port '%s`'"),
  MULTIPLE_BEHAVIOR("0xC1116", "Multiple conflicting behavior descriptions"),
  FEEDBACK_LOOP_CAUSALITY("0xC1117", "Feedback loop without strong causality"),
  ...
  TYPE_REF_NO_EXPRESSION("0xC1121", "Expected an expression"),
  MULTIPLE_COMP_ARG_VALUES("0xC1122", "Multiple values for argument '%s'"),
  COMP_ARG_TYPE_MISMATCH("0xC1123", "Type mismatch, expected '%s' but provided '%s'"),
  OPTIONAL_PARAMS_LAST("0xC1124", "Mandatory parameter '%s' proceeds optional parameter '%s'"),
  COMP_ARG_KEY_INVALID("0xC1125", "Unexpected key argument '%s'"),
  POSITIONAL_ASSIGNMENT_AFTER_KEY("0xC1126", "Positional assignments after key argument"),
  SUBCOMPONENT_REFERENCE_CYCLE("0xC1127", "Infinite recursion, subcomponent reference cycle"),
  TOO_FEW_ARGUMENTS_HERITAGE("0xC1128", "Too few arguments, expected '%s' but provided '%S'"),
  TOO_MANY_ARGUMENTS_HERITAGE("0xC1129", "Too many arguments, expected '%s' but provided '%s'"),
  COMP_ARG_HERITAGE_TYPE_MISMATCH("0xC1130", "Type mismatch, expected '%s' but provided '%s'"),
  TYPE_REF_NO_EXPRESSION2("0xC1131", "Expected an expression"),
  IN_PORT_HERITAGE_TYPE_MISMATCH("0xC1132", "Incompatible types, clash with port of super component"),
  OUT_PORT_HERITAGE_TYPE_MISMATCH("0xC1133", "Incompatible types, clash with port of super component"),
  PORT_HERITAGE_DIRECTION_MISMATCH("0xC1134", "Incompatible direction, clash with port of super component"),
  PORT_REF_FIELD_INIT("0xC1135", "Port cannot be referenced in static context"),
  FIELD_INIT_TYPE_REF("0xC1136", "Expected an expression"),
