...
public class ModeAutomataInDecomposedComponentTest extends ModesAbstractTest {
  ...
  protected static Stream<Arguments> numberOfModeAutomataWithErrorProvider() {
    return Stream.of(
      ...
      Arguments.of(2, false, new ModesError[]{}),
      Arguments.of(3, false, new ModesError[]{}),
      Arguments.of(0, true, new ModesError[]{}),
      Arguments.of(1, true, new ModesError[]{ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT}),
      Arguments.of(2, true, new ModesError[]{ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT, ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT}),
      Arguments.of(3, true, new ModesError[]{ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT, ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT, ModesError.MODE_AUTOMATON_IN_ATOMIC_COMPONENT})
    );
  }
  ...
  public void testCocoWithNModeAutomata(int numberOfModeAutomata, boolean atomic, @NotNull ModesError... expectedErrors) {
    ...
    // When
    ModeAutomataInDecomposedComponent coco = new ModeAutomataInDecomposedComponent();
    coco.check(compType);
