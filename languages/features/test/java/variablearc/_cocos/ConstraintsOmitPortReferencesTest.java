...
public class ConstraintsOmitPortReferencesTest extends VariableArcAbstractTest {
  ...
  protected ConstraintsOmitPortReferences coco;
  ...
  protected void setCoCo() {
    coco = new ConstraintsOmitPortReferences();
  }
  ...
  protected ComponentTypeSymbol provideCompWithOwnPortRef() {
    ...
    ASTArcConstraintDeclaration firstConstraint =
      VariableArcMill.arcConstraintDeclarationBuilder()
        .setExpression(nameExpression(compInPortName)).build();

    ASTArcConstraintDeclaration secondConstraint = VariableArcMill.arcConstraintDeclarationBuilder()
      .setExpression(nameExpression(compOutPortName)).build();
