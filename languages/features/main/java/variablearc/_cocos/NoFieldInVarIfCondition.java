...
public class NoFieldInVarIfCondition implements VariableArcASTArcVarIfCoCo {

  protected final ArcBasisTraverser traverser;

  public NoFieldInVarIfCondition() {
    this(new NoFieldInStaticContextVisitor());
  }

  protected NoFieldInVarIfCondition(@NotNull ExpressionsBasisVisitor2 visit4BasisExpr) {
