...
dependencies {
  ...
  api(project(":generators:cd2pojo"))

  generateSymbolTable(project(":languages:montiarc"))
...
genSymbolTable { mustRunAfter(project(":generators:cd2pojo").tasks.withType(Test::class)) }
