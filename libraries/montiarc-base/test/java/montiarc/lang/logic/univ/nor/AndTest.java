...
import montiarc.lang.logic.gate.AndComp;
import montiarc.lang.logic.gate.AndCompBuilder;
...
class AndTest {
  ...
  void test(boolean a, boolean b, boolean q) {
    // Given
    montiarc.lang.logic.gate.AndComp sut = new montiarc.lang.logic.gate.AndCompBuilder().setName("sut").build();
    ...
    // Then
    Assertions.assertThat(actual_q.getObservedValues()).containsExactly(q);
  }
  ...
  void test(@NotNull List<Message<Boolean>> a,
    ...
    // Given
    AndComp sut = new AndCompBuilder().setName("sut").build();
    PortObserver<Boolean> actual_q = new PortObserver<>();
