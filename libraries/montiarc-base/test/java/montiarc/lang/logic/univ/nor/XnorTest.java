...
import montiarc.lang.logic.gate.XnorComp;
import montiarc.lang.logic.gate.XnorCompBuilder;
...
class XnorTest {
  ...
  void test(boolean a, boolean b, boolean q) {
    // Given
    montiarc.lang.logic.gate.XnorComp sut = new montiarc.lang.logic.gate.XnorCompBuilder().setName("sut").build();
