...
import montiarc.lang.logic.gate.NotComp;
import montiarc.lang.logic.gate.NotCompBuilder;
...
class NotTest {
  ...
  void test(boolean a, boolean q) {
    // Given
    montiarc.lang.logic.gate.NotComp sut = new montiarc.lang.logic.gate.NotCompBuilder().setName("sut").build();
  ...
  void test(@NotNull List<Message<Boolean>> a,
    ...
    // Given
    NotComp sut = new NotCompBuilder().setName("sut").build();
  ...
  static Stream<Arguments> histories() {
    return Stream.of(
      ...
      // 5
      Arguments.of(
        List.of(msg(true), tk(), msg(true), tk(), msg(true), tk()), 
        List.of(msg(false), tk(), msg(false), tk(), msg(false), tk())),
      // 6
      Arguments.of(
        List.of(msg(true), tk(), msg(true), tk(), msg(false), tk()), 
        List.of(msg(false), tk(), msg(false), tk(), msg(true), tk())),
      // 7
      Arguments.of(
        List.of(msg(true), tk(), msg(false), tk(), msg(true), tk()), 
        List.of(msg(false), tk(), msg(true), tk(), msg(false), tk())),
      // 8
      Arguments.of(
        List.of(msg(true), tk(), msg(false), tk(), msg(false), tk()), 
