...
public class ShortDelayPort extends ShortOutPort implements INumericOutPort {

  protected short nextValue;

  public ShortDelayPort(String name) {
    super(name);
    this.nextValue = 0;
  }

  public ShortDelayPort() {
    this("");
  }
