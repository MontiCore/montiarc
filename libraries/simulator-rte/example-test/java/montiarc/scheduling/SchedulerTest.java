...
public class SchedulerTest {
  ...
  public static Stream<Arguments> methodSrc() {
    return Stream.of(
      Arguments.of(new FifoScheduler(), "a1a2b1b2c1c2d1d2e1e2f1f2g1g2h1h2i1i2j1j2k1k2"), // no overlapping computations: string matches RegEx ((.)1\22)+
      Arguments.of(new LifoScheduler(), "c1c2g1g2k1k2b1b2f1f2j1j2e1e2i1i2a1a2d1d2h1h2"), // no overlapping computations: string matches RegEx ((.)1\22)+
      Arguments.of(new InstantScheduler(), "a1d1h1h2d2a2b1e1i1i2e2f1j1j2f2b2c1g1k1k2g2c2") // overlapping computations: string does not match RegEx ((.)1\22)+
    );
  }
}
