...
public class IncomingStreamTest extends TestCase {
    ...
    public void testGetLastNTimeSlices() {
        ...
        assertEquals(testling.getIncomingStream().getUntimedHistory(), testling.getIncomingStream().getLastNTimeIntervals(25));
        assertEquals(testling.getIncomingStream().getUntimedHistory(), testling.getIncomingStream().getLastNTimeIntervals(26));
        assertEquals(testling.getIncomingStream().getUntimedHistory(), testling.getIncomingStream().getLastNTimeIntervals(100));
        assertNotSame(testling.getIncomingStream().getUntimedHistory(), testling.getIncomingStream().getLastNTimeIntervals(24));
        for (int i = 0; i < 26; i++) {
