...
public class SchedulerFactory {
  ...
  /**
   * @return a scheduler with default scheduling strategy that uses a {@link IPortMap} to store tickfree ports.
   */
  ...
  /**
   * @return a scheduler with default scheduling strategy that uses a {@link IPortMap} to store tickfree ports and
   * uses
   * a linked list instead of a map to store component related data structures.
   */
