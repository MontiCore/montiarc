...
public class Number2IntegerPort<I extends Number> extends AbstractOutPort<Integer> implements InOutPort<I, Integer> {

  public Number2IntegerPort(String qualifiedName, Component owner) {
  ...
  public void receive(Message<? extends I> message) {
    ...
    if (Tick.get().equals(message)) {
      ...
      this.send(message.getData().intValue());
    }
  }
