...
public class Number2DoublePort<I extends Number> extends AbstractOutPort<Double> implements InOutPort<I, Double> {

  public Number2DoublePort(String qualifiedName, Component owner) {
  ...
  public void receive(Message<? extends I> message) {
    ...
    if (Tick.get().equals(message)) {
      ...
      this.send(message.getData().doubleValue());
    }
  }
