...
public class Number2LongPort<I extends Number> extends AbstractOutPort<Long> implements InOutPort<I, Long> {

  public Number2LongPort(String qualifiedName, Component owner) {
  ...
  public void receive(Message<? extends I> message) {
    ...
    if (Tick.get().equals(message)) {
      ...
      this.send(message.getData().longValue());
    }
  }
