...
public class Number2ShortPort<I extends Number> extends AbstractOutPort<Short> implements InOutPort<I, Short> {

  public Number2ShortPort(String qualifiedName, Component owner) {
  ...
  public void receive(Message<? extends I> message) {
    ...
    if (Tick.get().equals(message)) {
      ...
      this.send(message.getData().shortValue());
    }
  }
