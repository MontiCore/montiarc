...
public class Char2DoublePort extends AbstractOutPort<Double> implements InOutPort<Character, Double> {

  public Char2DoublePort(String qualifiedName, Component owner) {
