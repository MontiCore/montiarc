...
public class Number2FloatPort<I extends Number> extends AbstractOutPort<Float> implements InOutPort<I, Float> {

  public Number2FloatPort(String qualifiedName, Component owner) {
  ...
  public void receive(Message<? extends I> message) {
    ...
    if (Tick.get().equals(message)) {
      ...
      this.send(message.getData().floatValue());
    }
  }
