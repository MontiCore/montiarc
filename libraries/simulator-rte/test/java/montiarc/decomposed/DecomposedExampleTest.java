...
public class DecomposedExampleTest {
  ...
  public void beforeEach() {
    ...
    input.connectTo(decomposed.iIn);
    ...
    decomposed.gtEq0.count.connectTo(gtEq0Recipient);
    ...
    decomposed.lt0.count.connectTo(lt0Recipient);
  }
